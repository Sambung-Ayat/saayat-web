...
export function DraggableOption({
  ...
  if (isSelected) {
    return (
      <div className="w-full p-4 rounded-xl border-2 border-dashed border-border bg-muted/20 opacity-50 flex items-center justify-center min-h-20">
  ...
  if (isDragging) {
    return (
      <div className="w-full p-4 rounded-xl bg-muted/10 border-2 border-primary/20 opacity-30 min-h-20" />
    );
  }
  ...
  return (
    ...
    >
      <p
        className="font-arabic text-lg sm:text-xl md:text-2xl text-center leading-relaxed"
        dir="rtl"
      >
        {option.text}
      </p>
